...
def get_googlecal_api_service():
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                #Credentials.json is not saved on github, so it must be redownloaded from https://developers.google.com/calendar/quickstart/python for this feature to work
